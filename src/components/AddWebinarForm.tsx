...
<div className="px-4 sm:px-6 md:px-10 lg:px-[90px] mt-6 mb-8">
  <div className="bg-white shadow-lg rounded-xl p-4 sm:p-6 border border-gray-200">
    <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-4 flex items-start sm:items-center gap-2">
      <svg className="w-5 h-5 text-green-500 mt-0.5 sm:mt-0" fill="currentColor" viewBox="0 0 24 24">
        <path d="M16.5 13.5c-.4-.2-2.3-1.1-2.7-1.2-.3-.1-.5-.2-.7.2s-.8 1.2-1 1.5-.4.3-.7.1c-.9-.4-1.8-1.1-2.5-2s-1.6-2.3-2-3.2c-.1-.3 0-.5.1-.7.1-.1.3-.3.5-.5.2-.2.3-.3.5-.6.1-.2.1-.4 0-.6s-.7-1.8-1-2.4c-.3-.7-.5-.6-.7-.6H6c-.2 0-.5.1-.7.3-.2.2-1.3 1.2-1.3 3s1.4 3.5 1.6 3.8c.2.3 2.8 4.2 6.7 5.9.9.4 1.6.6 2.1.7.9.3 1.8.3 2.5.2.8-.1 2.3-.9 2.6-1.7.3-.8.3-1.5.2-1.7s-.3-.2-.7-.4zM12 2C6.5 2 2 6.5 2 12c0 1.8.5 3.6 1.3 5.1L2 22l5-1.3c1.5.8 3.3 1.3 5 1.3 5.5 0 10-4.5 10-10S17.5 2 12 2z" />
      </svg>
      WhatsApp Group Link
    </h3>
    <input
      ...
      value={formData.whatsapp_link}
      onChange={handleChange}
      className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition duration-200 text-sm"
    />
