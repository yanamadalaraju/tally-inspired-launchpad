    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row max-w-6xl mx-auto mt-28 p-6 gap-6">
        ...
        <div className="lg:w-1/2 bg-white p-4 rounded-lg shadow-lg border border-gray-200">
          <h2 className="text-lg font-semibold text-center text-blue-700 mb-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-sm">
            <input
              ...
              required
              className="w-full px-3 py-1.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:outline-none"
            />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="flex gap-3">
                ...
                <select
                  ...
                  className="px-3 py-1.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:outline-none"
                >
            ...
            <div>
              ...
              {formData.takeaways.map((item, index) => (
                <input
                  ...
                  className="w-full px-3 py-1.5 mb-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:outline-none"
                  required
                />
              ))}
